        ...
        <div class="space-y-6">
            ...
            <div>
                <div class="flex justify-between items-center">
                    ...
                    <button class="bg-gray-200 relative inline-flex h-6 w-11 items-center rounded-full focus:outline-none">
                        <span class="sr-only">Toggle</span>
                        <span class="translate-x-1 inline-block h-4 w-4 transform bg-white rounded-full transition-transform"></span>
                    </button>
                </div>
            ...
            <div>
                <div class="flex justify-between items-center">
                    ...
                    <button class="bg-blue-500 relative inline-flex h-6 w-11 items-center rounded-full focus:outline-none">
                        <span class="sr-only">Toggle</span>
                        <span class="translate-x-6 inline-block h-4 w-4 transform bg-white rounded-full transition-transform"></span>
                    </button>
                </div>

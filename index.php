...
<body class="bg-gray-100">
    ...
    <!-- Image Slider -->
    <div class="relative w-full max-w-full mx-auto mb-16">
        <!-- Slider Images -->
        <div class="relative overflow-hidden h-80"> <!-- Adjusted height -->
            <div class="flex transition-transform duration-500 ease-in-out" id="slider">
                <img src="https://via.placeholder.com/1600x400?text=Image+1" class="w-full h-full object-cover">
                <img src="https://via.placeholder.com/1600x400?text=Image+2" class="w-full h-full object-cover">
                <img src="https://via.placeholder.com/1600x400?text=Image+3" class="w-full h-full object-cover">
                <img src="https://via.placeholder.com/1600x400?text=Image+4" class="w-full h-full object-cover">
                <img src="https://via.placeholder.com/1600x400?text=Image+5" class="w-full h-full object-cover">
            </div>
        </div>

        <!-- Left and Right Toggle -->
        <button id="prev" class="absolute top-1/2 left-0 transform -translate-y-1/2 p-3 bg-gray-800 text-white rounded-full">
            &#10094;
        </button>
        <button id="next" class="absolute top-1/2 right-0 transform -translate-y-1/2 p-3 bg-gray-800 text-white rounded-full">
            &#10095;
        </button>

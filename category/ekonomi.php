    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <?php for ($i = 1; $i <= 4; $i++): ?>
            <div class="relative">
                ...
                <div class="p-4">
                    <span class="text-red-500 font-bold">Ekonomi</span> <span class="text-gray-500">| 27 Januari 2025</span>
                    <a href="../news-detail.php">
                        <h3 class="text-lg font-bold mt-1">Judul Berita Ekonomi <?= $i ?></h3>
                    </a>
                    <p class="text-gray-700">Deskripsi singkat berita ekonomi <?= $i ?>...</p>
                </div>
            </div>
        <?php endfor; ?>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
            <a href="../news-detail.php" class="relative overflow-hidden rounded-lg">
                ...
                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                    <span class="text-white font-bold">Ekonomi | 3 menit lalu</span>
                    <h3 class="text-white text-lg font-bold mt-1">Judul Berita Populer Ekonomi 1</h3>
                </div>
            </a>
            <a href="../news-detail.php" class="relative overflow-hidden rounded-lg">
                <img src="https://via.placeholder.com/300x200" class="w-full h-56 object-cover">
                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                    <span class="text-white font-bold">Ekonomi | 3 menit lalu</span>
                    <h3 class="text-white text-lg font-bold mt-1">Judul Berita Populer Ekonomi 2</h3>
                </div>
            </a>
            <a href="../news-detail.php" class="relative overflow-hidden rounded-lg">
                <img src="https://via.placeholder.com/300x200" class="w-full h-56 object-cover">
                <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4">
                    <span class="text-white font-bold">Ekonomi | 3 menit lalu</span>
                    <h3 class="text-white text-lg font-bold mt-1">Judul Berita Populer Ekonomi 3</h3>
                </div>
            </a>
        </div>
    </div>

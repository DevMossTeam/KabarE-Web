...
<div class="container mx-auto mt-8 mb-16 px-6 lg:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <?php
        $query = "SELECT id, judul, konten_artikel, kategori, tanggal_dibuat FROM berita WHERE kategori = 'UKM' ORDER BY RAND() LIMIT 4";
    ...
    <div class="py-8 mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
            <?php
            $queryPopuler = "SELECT id, judul, konten_artikel, kategori, tanggal_dibuat FROM berita WHERE kategori = 'UKM' ORDER BY tanggal_dibuat DESC LIMIT 3";
    ...
    <div class="container mx-auto mt-8 mb-16 px-4 lg:px-20">
        <div class="flex flex-col lg:flex-row">
            ...
            <div class="w-full lg:w-2/3 pr-4">
                ...
                <?php
                $queryLainnya = "SELECT id, judul, konten_artikel, kategori, tanggal_dibuat FROM berita WHERE kategori != 'UKM' ORDER BY RAND() LIMIT 4";

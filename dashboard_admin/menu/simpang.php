...
<body class="bg-[#ECEFF5]">
                ...
                <form id="tagForm" action="#">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_tag" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type product name" required>
                        </div>
    ...
    <script>
        ...
        function resetFormAndCloseDrawer() {
            ...
            document.getElementById('tagForm').removeAttribute('data-edit-id');

...
<body class="bg-[#ECEFF5]">
    ...
    <div class="p-4 sm:ml-64 mt-14">
        <div class="p-4 dark:border-gray-50 mt-5">
            <div class="grid grid-cols-4 gap-4">
            <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
  <div class="flex justify-between items-center mb-3">
    <h5 class="text-xl font-semibold text-gray-900">Need help with a Claim?</h5>
  ...
  <p class="mb-3 font-normal text-gray-500">Follow this step-by-step guide on certifying for your weekly benefits:</p>
  <a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
    ...
    <svg class="w-3 h-3 ml-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11v4.833A1.166 1.166 0 0 1 13.833 17H2.167A1.167 1.167 0 0 1 1 15.833V4.167A1.166 1.166 0 0 1 2.167 3h4.618m4.447-2H17v5.768M9.111 8.889l7.778-7.778"/>
                ...
                <!-- Repeat the same card for additional content -->
            </div>

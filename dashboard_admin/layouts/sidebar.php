 ...
 <aside id="sidebar-multi-level-sidebar" class="fixed top-[80px] left-0 z-50 w-64 h-full transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-blue-50 dark:bg-[#1C2434]">
           <ul class="space-y-2 font-medium">
               <li>
                  <a href="../home/index.php" class="flex items-center p-2 text-blue-900 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700 group">
              ...
              <li>
                  ...
                  <ul id="dropdown-example" class="hidden py-2 space-y-2 peer-checked:block">
                     <li>
                           <a href="../menu/tag.php" class="flex items-center w-full p-1 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-indigo-100 dark:text-white dark:hover:bg-indigo-700">Tag</a>
                     </li>
                     <li>
              ...
              <li>
                  <a href="../menu/pengguna.php" class="flex items-center p-2 text-blue-900 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700 group">
              ...
              <!-- <li>
               ...
               <li>
                  <a href="../menu/inbox.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group text-xl">
               ...
               <li>
                  <a href="../menu/pengaturan.php" class="flex items-center p-2 text-blue-900 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-gray-700 group">

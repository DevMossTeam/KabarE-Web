...
<body class="bg-white flex items-center justify-center h-screen">
    ...
    <div class="w-full max-w-md">
        <h2 class="text-3xl font-bold mb-2 text-center" style="color: #61A6FF;">Belum Punya Akun?</h2>
        ...
        <form action="register.php" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <div class="mb-4">
                <label for="fullname" class="block text-sm font-bold mb-2" style="color: #7C7C7C;">NAMA LENGKAP</label>
            ...
            <div class="mb-4">
                <label for="username" class="block text-sm font-bold mb-2" style="color: #7C7C7C;">USERNAME</label>
        ...
        <p class="text-center mt-4 text-sm" style="color: #929292;">Dengan mendaftar di KabarE, kamu setuju untuk mematuhi kebijakan privasi kami dan menyetujui syarat serta ketentuan layanan yang berlaku.</p>
    </div>
</body>
</html>
